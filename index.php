...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <a href="hms/online_d/index.php" class="appointment-btn scrollto"><span class="d-none d-md-inline">Online</span> Consulting</a>
    </div>
  </header><!-- End Header -->
        ...
        <div class="row">
          ...
          <div class="col-lg-2 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="#healthlibrary.php">Health Library</a></li>
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            <h4>Our Services</h4>
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="hms/book-appointment.php">E-Channeling</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="hms/online_d/index.php">Online Consulting </a></li>
