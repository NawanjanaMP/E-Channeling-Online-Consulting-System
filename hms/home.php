    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="healthlibrary.php">Health Library</a></li>
...
<div class="swiper-slide">
        ...
        <div class="row no-gutters">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="assets1/img/gallery/gallery-1.jpg" class="galelry-lightbox">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="assets1/img/gallery/gallery-2.jpg" class="galelry-lightbox">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="assets1/img/gallery/gallery-3.jpg" class="galelry-lightbox">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="assets1/img/gallery/gallery-4.jpg" class="galelry-lightbox">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="assets1/img/gallery/gallery-5.jpg" class="galelry-lightbox">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="assets1/img/gallery/gallery-6.jpg" class="galelry-lightbox">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="assets1/img/gallery/gallery-7.jpg" class="galelry-lightbox">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="assets1/img/gallery/gallery-8.jpg" class="galelry-lightbox">
    ...
    <section id="contact" class="contact">
      ...
      <div class="container">
        ...
        echo "<script>alert('Your Message Has Been Sent Successfully'); window.location.href='home.php';</script>";
			}
		}
	 ?>
          ...
          <div class="col-lg-8 mt-5 mt-lg-0">
              ...
              <div class="row">
                <div class="col-sm-9 form-group">
                	<br>
                  <div class="text-center"><button type="submit" name="sendmail" class="btn btn-primary">Send Message</button></div>
