...
$sql=mysqli_query($con,"insert into doctors(specilization,doctorName,address,docFees,contactno,docEmail,password,startdoctime) values('$docspecialization','$docname','$docaddress','$docfees','$doccontactno','$docemail','$password','$startdoctime')");
if($sql)
{
...
<div class="form-group">
					...
					<input  name="startdoctime" class="form-control"  placeholder="Enter Doctor Available Time"  id="timepicker1" required="required">
														</div>
