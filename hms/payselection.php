...
function Successful(){
    ...
    alert("Your Appoinment Is Successfully Booked");
...
<article class="card">
	<div class="container">
		...
		<!--	<div class="payment-type">
				...
				<div class="types flex justify-space-between">
					<div class="type" onclick="myFunction1()">
						<div class="logo">
					...
					<div class="type"  onclick="myFunction()">
						<div class="logo">
							<i class="far fa-money-bill-alt"></i>
						</div>
						<div class="text">
							<p>Pay Cash At Door</p>
						</div>
					</div>
    ...
    <a href="home.php" button class="button button-link">Return</button></a>
			</div>	
    <div class="flex-end">
