...
$query=mysqli_query($con,"insert into users(fullname,address,city,gender,email,password,contactnumber,age) values('$fname','$address','$city','$gender','$email','$password','$contactnumber','$age')");
if($query)
{
	...
	<body class="login">
		...
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../index.php"><h2>DOC+ | Patient Registration</h2></a>
				</div>
				<!-- start: REGISTER BOX -->
